...
export const metadata = {
  title: 'Calculateur Taxe de Bienvenue Candiac 2025 | Droits de Mutation',
  description: 'Estimez vos droits de mutation à Candiac en 2025. Calculez les frais pour le Vieux-Candiac, le quartier Symphonie ou Montcalm. Experts en financement sur la Rive-Sud.',
  keywords: [
    'taxe de bienvenue candiac 2025',
    'calculateur droits de mutation candiac',
    'immobilier candiac rive-sud',
    'prix maison candiac 2025',
  ...
  openGraph: {
    title: 'Calculateur Taxe de Bienvenue Candiac 2025',
  ...
  twitter: {
    ...
    title: 'Taxe de Bienvenue Candiac 2025 - Estimation Rive-Sud',
    ...
    "@graph": [
      {
        ...
        "description": "Calculateur gratuit des droits de mutation pour la ville de Candiac (Rive-Sud) selon les barèmes 2025.",
        "offers": {
          "@type": "Offer",
          "price": "0",
          "priceCurrency": "CAD"
        ...
        "mainEntity": [
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Pour une propriété de 550 000 $ à Candiac en 2025, la taxe de bienvenue s'élève à environ 6 403,50 $."
            }
          },
          {
            "@type": "Question",
